...
| **Traductions (Loco)** | ❌ Non | `wp-content/languages/loco/plugins/` |
...
Les traductions de plugins (ex: SureCart) sont gérées via **Loco Translate** et stockées directement sur chaque site dans `wp-content/languages/loco/plugins/`. Elles ne sont pas versionnées dans Git.
...
### Transférer des traductions entre sites

Les traductions sont sur le même serveur O2switch, donc on peut copier directement :

```bash
# Exemple : copier les traductions SureCart de ecole vers ecole.jurible.com
cp ~/ecole/wp-content/languages/loco/plugins/surecart-fr_FR.* ~/ecole.jurible.com/wp-content/languages/loco/plugins/

# Exemple : copier vers jurible.com
cp ~/ecole/wp-content/languages/loco/plugins/surecart-fr_FR.* ~/jurible.com/wp-content/languages/loco/plugins/
```
