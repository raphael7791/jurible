<?php
/**
 * Title: Commerce 11 - CTA Sidebar Académie
 * Slug: jurible/commerce-11-cta-sidebar-academie
 * Categories: commerce
...
<div class="wp-block-group widget-cta-recommend__badge" style="border-radius:10px;padding-top:8px;padding-right:14px;padding-bottom:8px;padding-left:14px">
<!-- wp:paragraph {"style":{"typography":{"fontSize":"12px"}}} -->
<p style="font-size:12px">⭐</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontSize":"12px","fontWeight":"600"}},"textColor":"white"} -->
<p class="has-white-color has-text-color" style="font-size:12px;font-weight:600">Recommandé</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->

<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"18px","fontWeight":"700","lineHeight":"1.3"},"spacing":{"margin":{"top":"var:preset|spacing|xs"}}},"textColor":"white"} -->
<h3 class="wp-block-heading has-white-color has-text-color" style="margin-top:var(--wp--preset--spacing--xs);font-size:18px;font-weight:700;line-height:1.3">Rejoignez l'Académie</h3>
<!-- /wp:heading -->
