<?php
/**
 * Title: Commerce 06 - CTA Final Basique
 * Slug: jurible/commerce-06-cta-final-basique
 * Categories: commerce
 * Description: CTA final basique - 2 boutons + mentions
 */
?>
...
<h2 class="wp-block-heading has-text-align-center cta-final__title has-white-color has-text-color">Rejoignez l'Académie</h2>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-primary-white"><a class="wp-block-button__link wp-element-button" style="border-radius:var(--wp--preset--border-radius--md)">Découvrir l'Académie</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
