...
<div class="wp-block-group alignfull page-404 has-white-background-color has-background" style="min-height:70vh;padding-top:var(--wp--preset--spacing--xl);padding-right:var(--wp--preset--spacing--md);padding-bottom:var(--wp--preset--spacing--xl);padding-left:var(--wp--preset--spacing--md)">

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|sm"}},"layout":{"type":"constrained","contentSize":"560px"}} -->
<div class="wp-block-group">

<!-- wp:heading {"textAlign":"center","level":1,"style":{"typography":{"fontSize":"160px","fontStyle":"normal","fontWeight":"800","lineHeight":"1","letterSpacing":"-4px"}}} -->
<h1 class="wp-block-heading has-text-align-center" style="font-size:160px;font-style:normal;font-weight:800;letter-spacing:-4px;line-height:1"><mark style="background:linear-gradient(135deg, #B0001D 0%, #7C3AED 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text" class="has-inline-color">404</mark></h1>
<!-- /wp:heading -->

<!-- wp:heading {"textAlign":"center","level":2,"style":{"typography":{"fontSize":"40px","fontStyle":"normal","fontWeight":"700","lineHeight":"1.2","letterSpacing":"-0.5px"},"spacing":{"margin":{"top":"var:preset|spacing|md"}}},"textColor":"text-dark"} -->
<h2 class="wp-block-heading has-text-align-center has-text-dark-color has-text-color" style="margin-top:var(--wp--preset--spacing--md);font-size:40px;font-style:normal;font-weight:700;letter-spacing:-0.5px;line-height:1.2">Page introuvable</h2>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/contact">Contactez-nous</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->

<!-- wp:group {"style":{"spacing":{"margin":{"top":"var:preset|spacing|xl"},"blockGap":"var:preset|spacing|md"}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"center"}} -->
