<?php
/**
 * Title: H01 - Hero Conversion Suite IA
 * Slug: jurible/h01-hero-conversion-suite-ia
 * Categories: hero
...
<div class="wp-block-button is-style-primary"><a class="wp-block-button__link wp-element-button">Essayer gratuitement →</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
