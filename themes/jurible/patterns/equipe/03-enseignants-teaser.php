<?php
/**
 * Title: Equipe 03 - Enseignants Teaser
 * Slug: jurible/equipe-03-enseignants-teaser
 * Categories: equipe
 * Description: Section équipe avec photo de groupe sur fond gradient
 */
?>
...
<p class="has-text-align-center has-text-gray-color has-text-color has-body-large-font-size">Tous les contenus sont rédigés par 11 professionnels du droit — avocats, doctorants et chargés d'enseignement — tous titulaires d'un Master 2 minimum, dont les noms et le parcours sont disponibles sur notre site internet.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center","textColor":"text-gray","fontSize":"body-large"} -->
<p class="has-text-align-center has-text-gray-color has-text-color has-body-large-font-size">Parmi eux, Raphaël, ex-chargé d'enseignement à l'université de Nice, ancien avocat inscrit au barreau et titulaire du Master 2 Droit et pratiques des relations de travail de l'université Panthéon-Assas Paris II, est l'auteur des fiches de révision de droit des biens.</p>
<!-- /wp:paragraph -->
