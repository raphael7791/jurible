<?php
/**
 * Title: Confiance 01 - Reassurance Full
 * Slug: jurible/confiance-01-reassurance-full
...
<figure class="wp-block-image aligncenter size-full reassurance-full__partner-logo" style="margin-bottom:0"><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/partners/bpi-france.png'); ?>" alt="BPI France"/></figure>
<!-- /wp:image -->
</div>
<!-- /wp:column -->
...
<!-- wp:image {"align":"center","sizeSlug":"full","className":"reassurance-full__partner-logo","style":{"spacing":{"margin":{"bottom":"0"}}}} -->
<figure class="wp-block-image aligncenter size-full reassurance-full__partner-logo" style="margin-bottom:0"><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/partners/french-tech.jpg'); ?>" alt="La French Tech"/></figure>
<!-- /wp:image -->
</div>
<!-- /wp:column -->
