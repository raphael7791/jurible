...
class JAM_Access_Rules {
    ...
    public static function create( $data ) {
        ...
        $result = $wpdb->insert( $table, [
            ...
            'aide_perso_enabled'  => absint( $data['aide_perso_enabled'] ?? 0 ) ? 1 : 0,
            'aide_perso_copies'   => absint( $data['aide_perso_copies'] ?? 0 ),
            'aide_perso_questions'=> absint( $data['aide_perso_questions'] ?? 0 ),
