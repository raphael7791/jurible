...
function aga_formater_contenu_fiche_fc($content) {
    ...
    <div class="aga-result">
        ...
        <nav class="aga-result-breadcrumb">
            <a href="<?php echo home_url('/generateur-de-fiches-darret/'); ?>">Générateur</a>
        ...
        <div class="aga-result-actions">
            <a href="<?php echo home_url('/generateur-de-fiches-darret/'); ?>" class="aga-result-action aga-result-action--outline">
